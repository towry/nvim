...
function M.init_edit()
  ...
  o.diffopt:append { "algorithm:histogram", "indent-heuristic", "foldcolumn:0", "vertical", "linematch:50" }
...
function M.init_interface()
  ...
  vim.o.statuscolumn = '%s%=%{v:relnum?v:relnum:v:lnum} %{foldlevel(v:lnum) > 0 ? (foldlevel(v:lnum) > foldlevel(v:lnum - 1) ? (foldclosed(v:lnum) == -1 ? "" : "") : "│") : " " } '
