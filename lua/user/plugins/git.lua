...
plug({
...

  {
    ...
    keys = {
      { '<leader>gD', '<cmd>lua require("libs.git.utils").toggle_file_history()<cr>',    desc = 'Git files history' },
      ...
      { '<leader>gS', '<cmd>lua require("libs.git.utils").toggle_status()<cr>',          desc = 'Git status' },
    },
    cmd = {
      'DiffviewLog',
      'DiffviewOpen',
