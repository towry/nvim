  ...
  config = function()
    ...
    require('rose-pine').setup({
      ...
      highlight_groups = {
        ...
        StatusLineNC = {
          bg = utils.blend(utils.parse_color('base'), utils.parse_color('rose'), 0.07),
          fg = 'base',
        },
        TabLineSel = { bg = utils.blend(utils.parse_color('overlay'), utils.parse_color('rose'), 0.1), fg = 'text' },
