...
if vim.env['TMUX'] ~= nil then
    ...
    vim.keymap.set('n', '<localleader>xr', ':TmuxRerun', {
        noremap = false,
        silent = false,
    ...
    vim.keymap.set('n', '<localleader>xx', ':TmuxRun', {
        noremap = false,
        silent = false,
        desc = 'TmuxRun',
    })
...
create_cmd('Cdin', function(params)
    ...
    vim.g.cfg_root_cwd = require('v').path_remove_last_separator(cwd)
