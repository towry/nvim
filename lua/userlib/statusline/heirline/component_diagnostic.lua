...
return {
...

  {
    ...
    provider = function(self) return '' .. (self.error_icon or '') .. self.errors end,
    hl = 'DiagnosticError',
  },
  {
    condition = function(self) return self.warnings > 0 end,
    provider = function(self) return '' .. (self.warn_icon or '') .. self.warnings end,
    hl = 'DiagnosticWarn',
  },
  {
    condition = function(self) return self.info > 0 end,
    provider = function(self) return '' .. (self.info_icon or '') .. self.info end,
    hl = 'DiagnosticInfo',
  },
  {
    condition = function(self) return self.hints > 0 end,
    provider = function(self) return '' .. (self.hint_icon or '') .. self.hints end,
    hl = 'DiagnosticHint',
  },
  -- {
