...
local function on_blame_done(lines)
  ...
  vim.api.nvim_command("autocmd BufWinLeave <buffer> lua require('libs.git.blame').blame_quit()")
...
local function on_blame_commit_done(commit_hash, lines)
  ...
  vim.api.nvim_command("autocmd BufLeave <buffer> lua require('libs.git.blame').blame_commit_quit()")
