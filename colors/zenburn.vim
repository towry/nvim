...
hi VertSplit       guifg=#000000 guibg=NONE                   ctermfg=NONE ctermbg=NONE
...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    hi FoldColumn    guibg=NONE                         ctermbg=236 ctermfg=109
    hi Folded        guibg=#333333                         ctermbg=236 ctermfg=109
    if exists("g:zenburn_subdued_LineNr") && g:zenburn_subdued_LineNr
        hi LineNr        guifg=#5d6262 guibg=NONE           ctermfg=240 ctermbg=236
    else
        hi LineNr        guifg=#9fafaf guibg=NONE           ctermfg=248 ctermbg=235
    endif
